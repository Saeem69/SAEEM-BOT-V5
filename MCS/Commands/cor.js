...
const BG_URL = "https://drive.google.com/uc?export=view&id=19RynGjp6INw2nYW9v3vEMShq11-xMDZx";
...
module.exports.config = {
    ...
    role: 0,
    prefix: true,
    description: "Thief banner with elegant box design",
    category: "fun",
...
module.exports.onStart = async function (api, event, args) {
    ...
    const thiefMessages = [
        "এই যে দেখুন নতুন চোর! 😂",
        "সাবধান! এলাকা কাঁপানো চোর হাজির! 🏃‍♂️💨",
        "চুরি করার শখ মিটলো তো? 😈",
        "সবাই হাততালি দেন, নতুন চোর ধরা পড়েছে! 👏",
        "ওর আসল রূপটা দেখুন, একদম অরিজিনাল চোর! 🤡",
        "আজ থেকে তুই চোর বাহিনীর সদস্য! 🤣",
        "ইশ! চোরটা তো দেখি খুব কিউট! 💅",
        "গোপন খবর ফাঁস! চোর ধরা পড়লো! 🔥"
    ];
    ...
    try {
        ...
        const outPath = path.join(__dirname, `thief_${targetId}.png`);
